...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Hiệp - Trường TH Vĩnh Thành - ĐT: 0913784128</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Hiệp - Trường TH Vĩnh Thanhyf - ĐT: 0913784128</div>", unsafe_allow_html=True)
